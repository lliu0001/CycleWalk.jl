import Pkg
Pkg.activate("LCTRunner")

# Pkg.add("RandomNumbers")
# To run julia liftedTreeCycleWalk_CT.jl 1 0.01 1 0.3
# To run julia liftedTreeCycleWalk_CT.jl 2 0.01 1 0.3
# To run julia liftedTreeCycleWalk_CT.jl 3 0.01 1 0.3
# To run julia liftedTreeCycleWalk_CT.jl 4 0.01 1 0.3

# mapSamplerPath = joinpath("/gtmp/gjh/Projects", "multiscalemapsampler-dev-lct")
...
pop_dev = 0.02
cycle_walk_steps = 10^8
steps = Int(cycle_walk_steps/cycle_walk_frac)
outfreq = Int(2500/cycle_walk_frac)
...
pctGraphPath = joinpath("..", "data", "graph", "CT_pct20.json")
