...
function sample_spanning_tree(
    ...
    if nv(simple_graph) == 1
        ...
        # subtree_edges = kruskal_rmst(simple_graph, rng)
        # subtree_edges = wilson_rst(simple_graph, rng)
        subtree_edges = russo_ust(simple_graph, rng, steps=russo_steps)
...
function construct_cuttable_tree!(
    ...
    subtree, vmap_t2sg = sample_spanning_tree(simple_graph, rng, russo_steps)
